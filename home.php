 ...
 <header class="bg-dark py-5" id="main-header">
    <div class="container h-100 d-flex align-items-end justify-content-center w-100">
        <div class="text-center text-white w-100">
            <h1 class="display-4 fw-bolder">e-Indhann</h1>
            <p class="lead fw-normal text-white-50 mb-0">Remember for your engine</p>
            <div class="col-auto mt-2">
                <button class="btn btn-primary btn-lg rounded-0" id="send_request" type="button">Click Here for your Designated Service</button>
            </div>
        </div>
    </div>
</header>
...
<section class="py-5">
    <div class="container px-4 px-lg-5 mt-5">
        <div class="row">
            <div class="col-md-4">
                <h3 class="text-center">We provide services for:</h3>
