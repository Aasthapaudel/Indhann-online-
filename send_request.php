            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <select name="service_type" id="service_type" class="form-select form-select-sm select2 rounded-0" required>
                        ...
                        <option>Pick Up from on site</option>
                    </select>
                </div>
                ...
                <div class="form-group" style="display:onclick">
                    <label for="Delivery_address" class="control-label">Delivery Address</label>
                    <textarea rows="3" name="Delivery_address" id="Delivery_address" class="form-control form-control-sm rounded-0" style="resize:none" required></textarea>
                </div>
            </div>
        </div>
    </div>
