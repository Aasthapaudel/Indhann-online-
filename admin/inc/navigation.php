...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-no-expand">
        ...
        <img src="admin/inc/e--logo.png" alt="" class="brand-image img-circle elevation-3" style="opacity: .8;width: 34px;;height:34px;max-height: unset">
        <span class="brand-text font-weight-light"><?php echo $_settings->info('') ?></span>e-Indhann
        </a>
        <!-- Sidebar -->
